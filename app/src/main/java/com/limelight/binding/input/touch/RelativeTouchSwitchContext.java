...
public class RelativeTouchSwitchContext implements TouchContext {
    ...
    private static final int TAP_TIME_THRESHOLD = 100;
    private static final int DRAG_TIME_THRESHOLD = 160;

    private static final int SCROLL_SPEED_FACTOR = 8;
            ...
            if (actionIndex == 0) {
                ...
                if (pointerCount == 2) {
                    ...
                    if (prefConfig.absoluteMouseMode) {
                        ...
                        conn.sendMouseMove((short) (deltaX*1.5), (short) (deltaY*1.5));
                    }
                }
